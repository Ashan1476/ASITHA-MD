...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=auozRIAI#2hm3pAI_sDE4ZcPvFvALZqYarNMqSCiXaVL5J_Ysf2U",
GITHUB_USERNAME: process.env.GITHUB_USERNAME === undefined ? 'RASH': process.env.GITHUB_USERNAME,
